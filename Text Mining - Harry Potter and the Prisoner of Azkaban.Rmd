...
```{r}
# Update the list of characters to include Lupin
characters <- c("Harry", "Hermione", "Ron", "Sirius", "Snape", "Hagrid", "Dumbledore", "Lupin")

# Count mentions of each character in both the book and script
...
ggplot(character_comparison_df, aes(x = reorder(character, frequency), y = frequency, fill = version)) +
  ...
  scale_fill_manual(values = c("Book" = "#B40000", "Script" = "#0033A0"))  # Custom colors for Book and Script
